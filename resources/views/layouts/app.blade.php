                    ...
                    <div class="header-info">
                        <div class="info-inner">
                            ...
                            <span class="iconcont"><a
                                    href="tel:{{ $settings["phone"] ?? '123 123 123' }}">{{ $settings["phone"] ?? '+916200918716' }}</a></span>
                        </div>
                        <div class="info-inner">
                            <span class="icontop"><i class="fa fa-envelope" aria-hidden="true"></i></span>
                            <span class="iconcont"><a data-scroll
                                    href="mailto:{{ $settings["email"] ?? 'tauseed@test.com' }}">{{ $settings["email"] ?? 'theabhi.sam@gmail.com' }}</a></span>
                        </div>
                        <div class="info-inner">
                ...
                <div class="col-md-4">
                    <div class="footer-info padding">
                        ...
                        <p><i class="fa fa-map-marker"
                                aria-hidden="true"></i>{{ $settings["address"] ?? 'mohali, punjab' }}
                        </p>
                        <p><i class="fa fa-paper-plane"
                                aria-hidden="true"></i>{{ $settings["email"] ?? 'theabhi.sam@gmail.com' }}
                        </p>
                        <p><i class="fa fa-phone"
                                aria-hidden="true"></i>{{ $settings["phone"] ?? '+916200918716' }}</p>
                    </div>
                </div>
                @livewire('subscribe')
            </div>
